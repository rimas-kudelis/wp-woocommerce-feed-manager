...
class UtilsTest extends TestCase
{
    ...
    {
        $this->expectException(\RexGuzzleHttp\Promise\RejectionException::class);
    ...
    {
        $this->expectException(\RexGuzzleHttp\Promise\AggregateException::class);
    ...
    public function testAsyncPromisesWithCorrectlyYieldedValues()
    {
        ...
        eval('
        $promise = \RexGuzzleHttp\Promise\Coroutine::of(function () use ($promises) {
            $value = null;
            $this->assertSame(\'skip\', (yield new \RexGuzzleHttp\Promise\FulfilledPromise(\'skip\')));
