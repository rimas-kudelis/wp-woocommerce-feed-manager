...
The plugin is configured to generate product feed for over 111 major merchant shops with pre-defined templates for every merchant so that you can generate the feed in a few clicks.
...
* 111 pre-built templates of Merchant Shop feed
...
Currently, we support 111 major merchant shops:
- Google Shopping
- Google Adwords
