...
class WPFM_CMB2_Field extends WPFM_CMB2_Base {
	...
	public function save_field( $meta_value ) {
		 ...
		 * @param CMB2_Field object $field    This field object
		 */
		do_action( 'wpfm_cmb2_save_field', $field_id, $updated, $action, $this );
		 ...
		 * @param CMB2_Field object $field   This field object
		 */
		do_action( "wpfm_cmb2_save_field_{$field_id}", $updated, $action, $this );
	...
	public function render_field_callback() {
		 ...
		 */
		do_action( 'wpfm_cmb2_before_field_row', $this );
		 ...
		 * @param CMB2_Field $field The current field object.
		 */
		do_action( "wpfm_cmb2_before_{$field_type}_field_row", $this );
		 ...
		 * @param CMB2_Field $field The current field object.
		 */
		do_action( "wpfm_cmb2_after_{$field_type}_field_row", $this );
		 ...
		 * @param CMB2_Field $field The current field object.
		 */
		do_action( 'wpfm_cmb2_after_field_row', $this );
	...
	public function _set_field_defaults( $args ) {
		...
		if ( ! empty( $args['repeatable'] ) ) {
			WPFM_CMB2_JS::add_dependencies( 'jquery-ui-sortable' );
		}
	 ...
	 * @since  2.2.2
	 *
	 * @return WPFM_CMB2|WP_Error If new CMB2_Field is called without cmb_id arg, returns error.
	 */
	public function get_cmb() {
		...
		return wpfm_cmb2_get_metabox( $this->cmb_id, $this->object_id, $this->object_type );
	}
