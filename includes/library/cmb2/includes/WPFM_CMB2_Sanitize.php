...
class WPFM_CMB2_Sanitize {
	 ...
	 *
	 * @since 1.1.0
	 * @param WPFM_CMB2_Field $field A CMB2 field object.
	...
	public function taxonomy() {
		...
		if ( ! $this->field->args( 'taxonomy' ) ) {
            WPFM_CMB2_Utils::log_if_debug( __METHOD__, __LINE__, "{$this->field->type()} {$this->field->_id( '', false )} is missing the 'taxonomy' parameter." );
		} else {
