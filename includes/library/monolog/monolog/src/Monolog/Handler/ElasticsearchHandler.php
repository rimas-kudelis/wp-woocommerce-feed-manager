 ...
 */
namespace RexFeed\Monolog\Handler;

use Throwable;
use RuntimeException;
use RexFeed\Monolog\Logger;
use RexFeed\Monolog\Formatter\FormatterInterface;
use RexFeed\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use RexFeed\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use RexFeed\Elasticsearch\Client;
/**
