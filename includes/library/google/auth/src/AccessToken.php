...
use DateTime;
use Exception;
use RexFeed\Firebase\JWT\ExpiredException;
...
use RexFeed\phpseclib\Crypt\RSA;
use RexFeed\phpseclib\Math\BigInteger;
use RexFeed\Psr\Cache\CacheItemPoolInterface;
use RuntimeException;
use RexFeed\SimpleJWT\InvalidTokenException;
use RexFeed\SimpleJWT\JWT as SimpleJWT;
use RexFeed\SimpleJWT\Keys\KeyFactory;
use RexFeed\SimpleJWT\Keys\KeySet;
...
class AccessToken
{
    ...
    public function verify($token, array $options = [])
    {
        ...
        try {
            ...
            // firebase/php-jwt 3+
        } catch (\RexFeed\ExpiredException $e) {
            // firebase/php-jwt 2
        } catch (SignatureInvalidException $e) {
            // firebase/php-jwt 3+
        } catch (\RexFeed\SignatureInvalidException $e) {
            // firebase/php-jwt 2
    ...
    {
        // @codeCoverageIgnoreStart
        if (!\class_exists('RexFeed\\SimpleJWT\\JWT')) {
    ...
    {
        $class = 'RexFeed\\Firebase\\JWT\\JWT';
