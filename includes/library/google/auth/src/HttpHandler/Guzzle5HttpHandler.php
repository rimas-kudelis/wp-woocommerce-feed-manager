...
use RexFeed\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use RexFeed\GuzzleHttp\Promise\Promise;
use RexFeed\GuzzleHttp\Promise\RejectedPromise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('RexFeed\\GuzzleHttp\\Promise\\Promise')) {
