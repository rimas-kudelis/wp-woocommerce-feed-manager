...
use RexFeed\Google\Auth\Subscriber\ScopedAccessTokenSubscriber;
use RexFeed\Google\Auth\Subscriber\SimpleSubscriber;
...
*
*/
\class_alias('RexFeed\\Google_AuthHandler_Guzzle5AuthHandler', 'Google_AuthHandler_Guzzle5AuthHandler', \false);
