...
namespace RexTheme\RssShoppingFeed;

use RexTheme\RssShoppingFeed\Node;
use RexTheme\RssShoppingFeed\Containers\RssShoppingFeed;
use RexTheme\RssShoppingFeed\Exceptions\MissingIdentifierException;
...
//        $this->nodes['sale_price'] = $node->value( $salePrice . " {$code}" );
