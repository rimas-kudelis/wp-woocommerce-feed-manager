        ...
        foreach( $this->products as $productId ) {
            ...
            if ( $product->is_type( 'variable' ) && $product->has_child() ) {
                if($this->variable_product) {
                    ...
                    $this->add_to_feed( $variable_product, $product_meta_keys, 'variation' );
                }
    ...
    protected function get_product_data(  WC_Product $product, $product_meta_keys  ){
        ...
        if ( function_exists('icl_object_id') ) {
            ...
            if($wpml) {
                ...
                $data = new Rex_Product_Verjelijk_Data_Retriever( $product, $this->feed_config, null, $this->append_variation, $product_meta_keys, $analytics_params);
            }
        }else{
            $data = new Rex_Product_Verjelijk_Data_Retriever( $product, $this->feed_config, null, $this->append_variation, $product_meta_keys, $analytics_params);
        }
