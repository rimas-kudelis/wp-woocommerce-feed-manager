<!-- `rex-xml-popup` block -->
<section class="rex-xml-popup">
    <div class="rex-xml-popup__wrapper">
        <!-- `rex-xml-popup__body` element in the `rex-xml-popup` block  -->
        <div class="rex-xml-popup__body">
            <span class="rex-xml-popup__close-btn">
            ...
            <!-- `rex-xml-popup__message` element in the `rex-xml-popup` block  -->
            <div class="rex-xml-popup__message">
                <?php echo '<pre>', htmlentities( $feed_string ), '</pre>'; ?>
            </div>
        </div>
    </div>
</section>
<!-- `rex-xml-popup` block  end -->