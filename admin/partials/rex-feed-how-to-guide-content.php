...
<ol class="rex-feed-how-to-guide-lists">
    ...
    <li>
        <a href="https://rextheme.com/docs/how-to-generate-woocommerce-product-feed-for-google/?utm_source=plugin&utm_medium=get_started_google_doc_link&utm_campaign=pfm_plugin" target="_blank">
    ...
    <li>
        <a href="https://rextheme.com/docs/how-to-auto-sync-product-feed-to-google-merchant-shop/?utm_source=plugin&utm_medium=get_started_auto_sync_link&utm_campaign=pfm_plugin" target="_blank">
            <?php esc_html_e( 'Google Merchant Auto-sync', 'rex-product-feed' )?>
        </a>
    </li>
    <li>
        <a href="https://rextheme.com/docs/how-to-generate-woocommerce-product-feed-for-facebook/?utm_source=plugin&utm_medium=get_started_facebook_doc_link&utm_campaign=pfm_plugin" target="_blank">
...
<ol class="rex-feed-how-to-guide-lists">
    <li>
        <a href="https://rextheme.com/docs/wpfm-troubleshooting-for-common-issues/?utm_source=plugin&utm_medium=troubleshoot_button&utm_campaign=pfm_plugin" target="_blank">
