...
>
    <div class="wpfm-bf-wrapper">
        <div class="wpfm-logo">
            <img src="<?php echo WPFM_PLUGIN_ASSETS_FOLDER .'icon/logo.png'?>" alt="wpfm-black-friday">
        </div>
        <div class="wpfm-bf-text">
            <p><?php echo __('Upgrade to pro with a', 'rex-product-feed') ?></p>
            <h3><?php echo __('Huge Black Friday Discount', 'rex-product-feed') ?></h3>
            <p><?php echo __('Generate ultimate product feed in minutes.', 'rex-product-feed') ?></p>
        </div>
        <div class="wpfm-bf-button">
            ...
            <p class="wpfm-bf-coupon"><?php echo __('Coupon:', 'rex-product-feed') ?> REX19BF</p>
        </div>
    </div>
</div>