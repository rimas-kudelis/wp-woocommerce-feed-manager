...
<div class="rex_feed_config_div rex-feed-merchant">
	<label for="<?php echo esc_attr($this->prefix) . 'merchant'; ?>"><?php _e( 'Feed Merchant', 'rex-product-feed' ) ?>
...
<div class="rex_feed_config_div rex-feed-feed-format">
	<label for="<?php echo esc_attr($this->prefix) . 'feed_format'; ?>"><?php _e( 'Feed Type', 'rex-product-feed' ) ?>
		<span class="rex_feed-tooltip">
            <?php include WPFM_PLUGIN_ASSETS_FOLDER_PATH . $icon;?>
...
<div class="rex_feed_config_div rex-feed-feed-separator" style="display: none">
	<label for="<?php
	echo esc_attr($this->prefix) . 'separator'; ?>"><?php _e( 'Separator', 'rex-product-feed' ) ?>
		<span class="rex_feed-tooltip">
            <?php include WPFM_PLUGIN_ASSETS_FOLDER_PATH . $icon;?>
	...
	<select name="<?php echo esc_attr($this->prefix) . 'separator'; ?>" id="<?php echo esc_attr($this->prefix) . 'separator'; ?>" class="">
		<option value="comma" <?php echo esc_attr($checked_comma)?>><?php echo __( 'Comma (,)', 'rex-product-feed' ) ?></option>
		<option value="semi_colon" <?php echo esc_attr($checked_semi_colon)?>><?php echo __( 'Semi-colon (;)', 'rex-product-feed' ) ?></option>
		<option value="pipe" <?php echo esc_attr($checked_pipe)?>><?php echo __( 'Pipe (|)', 'rex-product-feed' ) ?></option>
	</select>
</div>